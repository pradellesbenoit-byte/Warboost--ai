...
assert.match(health,/ui_revision_final:"hf8\.5-final-alliance-desert-storm"/);
...
assert.match(sw,/hf8-5-final-alliance-desert-storm/);assert.match(sw,/desert-storm-plan\.js/);
assert.match(pkg.description,/HF8\.5 FINAL/);assert.match(pkg.scripts.check,/desert-storm-plan\.js/);assert.match(pkg.scripts.verify,/verify-v2\.5\.28-hf8-5-final\.mjs/);assert.match(manifest.name,/HF8\.5 FINAL/);
