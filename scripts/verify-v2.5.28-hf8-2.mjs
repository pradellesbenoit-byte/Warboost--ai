...
assert.match(html,/WarBoost V2\.5\.28 HF8\.[23]/);
...
assert.match(sw,/hf8-(?:2-vs-live-coach|3-vs-decision-engine)/);assert.match(health,/ui_revision:"hf8\.(?:2-vs-live-coach|3-vs-decision-engine)"/);
