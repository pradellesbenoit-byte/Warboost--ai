...
assert.match(html,/V2\.5\.28 HF8\.6\.(?:1|2|17)/);assert.match(manifest.name,/HF8\.6\.(?:1|2|17)/);
...
assert.match(pkg.description,/HF8\.6\.(?:1|2|17)/);assert.match(pkg.scripts.check,/roster-scan-queue\.js/);assert.match(pkg.scripts.verify,/verify-v2\.5\.28-hf8-6-1\.mjs/);
