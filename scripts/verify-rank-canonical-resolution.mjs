...
{
  const resolved=resolveCanonicalRosterMember(roster,{member_key:"canonical:obsolete|884|ALL4",name:"manulegaulois",server_id:"884",alliance_tag:"ALL4"},context);
  assert.equal(resolved.ok,true);
...

{
  ...
  const resolved=resolveCanonicalRosterMember(duplicate,{member_key:"canonical:obsolete|884|ALL4",name:"manulegaulois",server_id:"884",alliance_tag:"ALL4"},context);
...
{
  const resolved=resolveCanonicalRosterMember(roster,{member_key:"canonical:missing|884|ALL4",name:"missing",server_id:"884",alliance_tag:"ALL4"},context);
  assert.equal(resolved.ok,false);
