...
assert.match(app,/RELEASE_LABEL="HF8\.6\.(?:3|17)"/);assert.match(app,/previewAllianceRankChanges/);assert.match(app,/applyRankManagerChanges/);assert.match(app,/rankChangeDraft/);assert.match(html,/id="rankManagerSection"/);assert.match(html,/id="rankManagerApplyBtn"/);assert.match(api,/actorRole==="R4"/);assert.match(api,/r5_protected/);assert.match(api,/owner_required_for_r5/);assert.match(sw,/hf8-6-3-alliance-rank-manager/);assert.match(pkg.description,/HF8\.6\.(?:3|17)/);
