...
**How to apply:** Compare the target branch ref with the local commit, use the authenticated GitHub API for the repository operation, and verify the resulting SHA plus changed files before reporting success.
