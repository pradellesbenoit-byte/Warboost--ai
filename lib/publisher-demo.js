...
export const PUBLISHER_DEMO_VERSION="2.5.22";
...
export function buildPublisherDemoState(now=new Date().toISOString()){
  return {
    ...
    season:{name:"publisher-demo-season",number:null,day:18,total_days:35,profession:"engineer",progress_pct:51,resistance:5500,focus:"balanced",lifecycle:"active",lifecycle_source:"publisher-demo",ended_at:null,measured_hybrid_synergy:false,awakening_swap:null,updated_at:now},
