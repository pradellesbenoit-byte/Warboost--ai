...
## Changes
- Unconfirmed hero identities are now confirmed directly inside the expanded squad.
- Five native mobile-friendly hero selectors are displayed inline.
- All five identities are required before saving.
...
## Demo safeguard
WarBoost never invents an unresolved hero identity. If identity is uncertain, the user must explicitly confirm it.
